...
const test = require("./snippets/test.js")
...
const components = {
  ...
  // 		template: '<button type="button" className="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Button text </button>',
  // 	},
  // 	{
  // 		id: 2,
  // 		category: 'button',
...
async function getSearchResults(query) {
  let filtered = allComponents.filter((component) => {
	...
	return looseIncludes(component?.name, query) || looseIncludes(component?.category, query) || looseIncludes(component?.template, query)
  });
...
},{"./snippets/test.js":2}],2:[function(require,module,exports){
module.exports.TEST = [
    {
      id: 1,
      category: "test",
